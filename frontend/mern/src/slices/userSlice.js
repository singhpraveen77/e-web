...
export const login = createAsyncThunk(
    ...
    async ({ loginEmail, loginPassword }, { rejectWithValue }) => {
        try {
            ...
            // console.log("loginEmail,loginPassword:",loginEmail,loginPassword)
            const Response = await axios.post(`http://localhost:5000/app/v1/user/login`, { email: loginEmail, password: loginPassword },{
...
export const register = createAsyncThunk(
    ...
    async (userRegisterForm, { rejectWithValue }) => {
        try {
            ...
            const response = await axios.post(`http://localhost:5000/app/v1/user/register`, userRegisterForm);
...
export const loadUser = createAsyncThunk(
    ...
    async (_, { rejectWithValue }) => {
        try {
            const Response = await axios.get("http://localhost:5000/app/v1/user/me",{
                withCredentials:true
            });
            return Response.data;
        } catch (error) {
...
export const logout = createAsyncThunk(
    ...
    async (_, { rejectWithValue }) => {
        try {
            const Response = await axios.get("http://localhost:5000/app/v1/user/logout",{withCredentials:true});
            return Response.data;
        } catch (error) {
            const errorMessage = error.response?.data?.message || "An unexpected error occurred.";
            return rejectWithValue(errorMessage);
